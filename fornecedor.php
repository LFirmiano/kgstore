            ...
            <tbody>
              <tr>
                ...
                <form action="ver_fornecedor.php" method="POST">
                  <input type="hidden" value="<?php echo $row->id_fornecedor ?>" name="visualizar">
                ...
                <form action="" method="POST">
                  <button type="button" class="btn btn-outline-danger" style="float: left; margin-right: 3%;" value="<?php echo $row->id_fornecedor ?>" onclick="deletar(this)" data-toggle="modal" data-target="#exampleModal">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <form action="include/D_fornecedor.php" method="POST">
