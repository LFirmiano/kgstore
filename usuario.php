              ...
              <tr>
                <?php /*
                    ...
                    while($row = $stmt->fetch(PDO::FETCH_OBJ)){
                      // echo $row->produto;*/
                ?>
                <th scope="row"> Gabriel <?php //echo $row->nome ?></th>
                <td>gabriel@teste.com<?php // echo $row->data_nascimento ?></td>
                <td>Administração<?php //echo $row->telefone ?></td>
                <td>
                ...
                <!--botao excluir-->
                <form method="">
                  <input type="hidden" value="<?php //echo $row->id_cliente ?>" id="inpt" name="inpt">
