...
<body>
   ...
   <div style="margin-top:2%; margin-bottom:5%">
    <h2 class="text-center">
        <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-basket text-info" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <form action="detalhe_pedido.php" method="POST">
        <input type="hidden" value=<?php echo $_POST['id_voltar']?> name="visualizar">
