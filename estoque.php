...
<body>
   ...
   <a href="cad_produto.php" class="btn btn-outline-success" style="margin-bottom:2%;">Novo Produto</a>
   </div>
            ...
            <tbody>
              <tr>
                ...
                <form action="ver_produto.php" method="POST">
                  <input type="hidden" value="<?php echo $row->id_produto ?>">
                ...
                <form action="" method="POST">
                  <input type="hidden" value="<?php echo $row->id_produto ?>">
                  <button type="button" class="btn btn-outline-dark" style="float: left; margin-right: 3%;"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <form action="" method="POST">
                  <input type="hidden" value="<?php echo $row->id_produto ?>">
                  <button type="button" class="btn btn-outline-danger" style="float: left; margin-right: 3%;" data-toggle="modal" data-target="#exampleModal">
