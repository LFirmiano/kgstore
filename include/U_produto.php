...
$sql = "UPDATE estoque SET produto = :produtoest WHERE produto_id = :produtold";
...
$stmt->bindParam(':id',$_POST['prod'],PDO::PARAM_STR);

$stmt2->bindParam(':produtoest',$_POST['produto'],PDO::PARAM_STR);
$stmt2->bindParam(':produtold',$_POST['prod'],PDO::PARAM_STR);
